...
\begin{figure}[ht!]\centering\includegraphics[width=0.75\textwidth]{figures/cluster.tree-1.png} \caption{Comparison of Mohn's $\rho$ and $-2log(p)$ for runs test and Diabold Marino test.}\label{fig:xxx} \end{figure}
